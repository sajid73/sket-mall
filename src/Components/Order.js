...
function Order({ id, amount, amountShipping, items, timestamp, images}) {
    return (
        <div className="relative border rounded-md">
            <div className="flex items-center bg-gray-100 text-sm text-gray-600">
                <div>
                ...
                <p className="text-sm whitespace-nowrap sm:text-xl self-end flex-1 text right text-red-600">
                    {items.length} items
                </p>
